...
/**
 * Unit tests for {@link NearestNeighbourSolution}.
 */
class TestNearestNeighbourSolution {
    ...
    void testNullInput() {
        ...
        //when
        List<Point> result = TSPSolutionFactory.createSolution(SolutionType.NEAREST_NEIGHBOUR_ALGORITHM, inputPoints).getSolutionPoints();
    ...
    public void testRandomClusteredPoints() {
        ...
        //when
        ArrayList<Point> result = TSPSolutionFactory.createSolution(SolutionType.NEAREST_NEIGHBOUR_ALGORITHM, inputPoints).getSolutionPoints();
