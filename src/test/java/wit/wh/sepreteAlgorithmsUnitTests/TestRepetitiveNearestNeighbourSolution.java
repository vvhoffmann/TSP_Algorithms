...
public class TestRepetitiveNearestNeighbourSolution {
    /**
    ...
    void testNullInput() {
        ...
        //when
        List<Point> result = TSPSolutionFactory.createSolution(SolutionType.REPETITIVE_NEAREST_NEIGHBOUR_ALGORITHM, inputPoints).getSolutionPoints();
    ...
    public void testRandomClusteredPoints() {
        ...
        //when
        ArrayList<Point> result = TSPSolutionFactory.createSolution(SolutionType.REPETITIVE_NEAREST_NEIGHBOUR_ALGORITHM, inputPoints).getSolutionPoints();
