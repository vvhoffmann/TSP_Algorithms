...
public class TestSASolution {
    ...
    void testNullInput() {
        ...
        //when
        List<Point> result = TSPSolutionFactory.createSolution(SolutionType.SA_ALGORITHM, inputPoints).getSolutionPoints();
    ...
    void testIfRoundRouteCreated() {
        ...
        //then
        Assertions.assertEquals(inputSize + 1, result.size());
    ...
    public void testRandomClusteredPoints() {
        ...
        //when
        ArrayList<Point> result = TSPSolutionFactory.createSolution(SolutionType.SA_ALGORITHM, inputPoints).getSolutionPoints();
