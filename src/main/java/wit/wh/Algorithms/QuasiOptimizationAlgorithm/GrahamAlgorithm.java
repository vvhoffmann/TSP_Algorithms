...
public class GrahamAlgorithm {
     ...
     *
     * @param sourcePoints The input list of points.
     ...
     */
    public static ArrayList<Point> getConvexHull(ArrayList<Point> sourcePoints) {
        if(sourcePoints.size() < 3)
            return sourcePoints;

        ArrayList<Point> points = new ArrayList<Point>(sourcePoints);
